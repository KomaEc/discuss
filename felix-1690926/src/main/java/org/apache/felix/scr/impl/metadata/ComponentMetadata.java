...
public class ComponentMetadata
{
     ...
     * constants.
     */
    public @Nullable DSVersion getDSVersion()
    {
        return m_dsVersion;
    }
     ...
     */
    public @Nullable List<String> getConfigurationPid()
    {
        if ( !m_validated )
        {
     ...
     */
    public @Nullable String getFactoryIdentifier()
    {
        return m_factory;
    }
     ...
     * @since 1.2.0 (DS 1.1)
     */
    public @Nullable String getConfigurationPolicy()
    {
     ...
     * @since 1.2.0 (DS 1.1)
     */
    public @Nullable String getActivate()
    {
        return m_activate;
    }
     ...
     * @since 1.2.0 (DS 1.1)
     */
    public @Nullable String getDeactivate()
    {
        return m_deactivate;
    }
     ...
     */
    public @Nullable ServiceMetadata getServiceMetadata()
    {
        return m_service;
    }
     ...
     */
    public @Nullable List<ReferenceMetadata> getDependencies()
    {
        return m_references;
    }
