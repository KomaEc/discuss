...
class CustomConverterImpl implements InternalConverter {
	...
	@Override
	public @Nullable InternalConverting convert(Object obj) {
	...
	private class ConvertingWrapper implements InternalConverting {
		...
		@Override
		public <T> @Nullable T to(Class<T> cls) {
			Type type = cls;
			return (T) to(type);
		}
		...
		@SuppressWarnings("unchecked")
		@Override
		public @Nullable Object to(Type type) {
        ...
        private @Nullable List<ConverterFunction> getErrorHandlers(Converter converter) {
