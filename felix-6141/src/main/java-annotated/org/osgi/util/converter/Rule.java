...
public abstract class Rule<F, T> implements TargetRule {
	...
	private @Nullable ConverterFunction getGenericFunction(final Function<F,T> func) {
	...
	@Override
	public @Nullable ConverterFunction getFunction() {
		return function;
	}

	@Override
	public @Nullable Type getTargetType() {
